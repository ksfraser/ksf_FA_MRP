 ...
 * 
 * @package KsfFA_ksf_FA_MRP
 * @version 2.4.3
 */

define('SS_ksf_FA_MRP', 130 << 8);
...
class hooks_ksf_FA_MRP extends hooks {
    ...
    function install_access() {
        ...
        $security_areas['SA_ksf_FA_MRPVIEW'] = array(
            SS_ksf_FA_MRP | 1, 
            _("View ")
        );
        $security_areas['SA_ksf_FA_MRPMANAGE'] = array(
            SS_ksf_FA_MRP | 2, 
            _("Manage ")
        );
