<?php
/**
 * ksf_FA_MRP Module Hooks for FrontAccounting
 */

define('SS_ksf_FA_MRP', 100 << 8);

class hooks_ksf_FA_MRP extends hooks {
    var $module_name = 'ksf_FA_MRP';
    ...
    function install_access() {
        $security_sections[SS_ksf_FA_MRP] = _("");
        $security_areas['SA_ksf_FA_MRPVIEW'] = array(SS_ksf_FA_MRP | 1, _("View "));
        $security_areas['SA_ksf_FA_MRPMANAGE'] = array(SS_ksf_FA_MRP | 2, _("Manage "));
